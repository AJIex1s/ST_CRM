...
export class ControlsFactory {
    ...
    createControl(componentType: Type<BaseFormComponent>,
        params: ComponentParams): ComponentRef<BaseFormComponent> {
        ...
        let componentRef = factory.create(injector) as ComponentRef<BaseFormComponent>;
    ...
    createTextFieldControl(): ComponentRef<TextFieldComponent> {
        let params = new InputFormComponentParams(HtmlInputType.text, "Text Field");
